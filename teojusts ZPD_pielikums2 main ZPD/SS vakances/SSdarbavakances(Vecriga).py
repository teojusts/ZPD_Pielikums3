...
def perform_initial_selections():
    try:
        ...
        # 3. Click the second dropdown to select and type "Vecrī"
        ...
        dropdown_element_2.send_keys("Vecrī")
...
def scrape_all_pages(start_page=1, max_pages=4):
    ...
    # Perform the initial selections (type 'r' and 'Vecrī')
    ...
    with open("Vecriga_vakances.json", "w", encoding="utf-8") as f:
