...
def perform_initial_selections():
    try:
        ...
        # 3. Click the second dropdown to select and type "Vecāķ"
        ...
        dropdown_element_2.send_keys("Vecāķ")
...
def scrape_all_pages(start_page=1, max_pages=4):
    ...
    # Perform the initial selections (type 'r' and 'Vecāķ')
    ...
    with open("Vecaki_vakances.json", "w", encoding="utf-8") as f:
