...
def calculate_avg_price_per_district(districts):
    """
    Calculate average price per district based on the district's JSON file.
    Exclude districts with less than 8 values.
    """
    district_prices = {}
    ...
    for district in districts:
        ...
        # Only include districts with 6 or more valid prices
        if len(prices) >= 6:
...
districts = [
    ...
    "Darzciems", "Daugavgriva", "Dreilini", "DzegužkalnsDzircems", "Grizinkalns", 
    ...
    "Vecmilgravis", "Vecriga", "Voleri", "Zasulauks", "Ziepniekkalns", "Zolitude", "Skanste", "Brasa", "Avoti", "Andrejsala"
]

output_file = 'AVG_ss_darbavakances.json'  # Output file to store averages

# Calculate average prices per district
district_averages = calculate_avg_price_per_district(districts)
